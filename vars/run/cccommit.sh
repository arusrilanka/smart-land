...
peer lifecycle chaincode commit -o $ORDERER_ADDRESS --channelID mychannel \
  ...
  --peerAddresses peer1.notary.ousl.com:7051 \
  --tlsRootCertFiles /vars/keyfiles/peerOrganizations/notary.ousl.com/peers/peer1.notary.ousl.com/tls/ca.crt \
  --peerAddresses peer1.other.ousl.com:7051 \
  --tlsRootCertFiles /vars/keyfiles/peerOrganizations/other.ousl.com/peers/peer1.other.ousl.com/tls/ca.crt \
