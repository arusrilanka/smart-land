...
export CORE_PEER_ADDRESS=peer2.other.ousl.com:7051
export CORE_PEER_TLS_ROOTCERT_FILE=/vars/keyfiles/peerOrganizations/other.ousl.com/peers/peer2.other.ousl.com/tls/ca.crt
...
jq '.channel_group.groups.Application.groups."other-ousl-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer2.other.ousl.com","port": 7051}]},"version": "0"}}' mychannel_current_config.json > mychannel_modified_anchor_config.json
